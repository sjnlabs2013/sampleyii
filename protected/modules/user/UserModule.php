...
class UserModule extends CWebModule
{
	...
	public static function sendMail($email,$subject,$message) {
            $logo = CHtml::image(Yii::app()->request->getBaseUrl(true).'/images/mail-logo.png',Yii::app()->name, array('style'=>'height:70px'));
            //$adminEmail = Yii::app()->params['adminEmail'];
            $adminEmail = Yii::app()->params['postmasterEmail'];
	    ...
	    $message = str_replace("\n.", "\n..", $message);
            $message = '<table width="600px">'
                    . '<tr><td>'.$logo.'</td><tr>'
                    . '<tr><td>'.$message.'</td><tr>'
                    . '<tr><td>PLEASE DO NOT REPLY. THIS IS AUTOMATED MESSAGE</td><tr>'
                    . '</table>';
