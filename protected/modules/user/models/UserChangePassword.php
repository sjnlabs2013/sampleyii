...
class UserChangePassword extends CFormModel {
	...
	public function rules() {
		return Yii::app()->controller->id == 'recovery' ? array(
			...
			//array('password, verifyPassword', 'length', 'max'=>512, 'min' => 10,'message' => UserModule::t("Incorrect password (minimal length 10 symbols).")),
			array('password, verifyPassword', 'length', 'max'=>512, 'min' => 6,'message' => UserModule::t("Minimum 6 Characters")),
                    
			array('verifyPassword', 'compare', 'compareAttribute'=>'password', 'message' => UserModule::t("Retyped Password does not match.")),
		) : array(
			...
			//array('oldPassword, password, verifyPassword', 'length', 'max'=>512, 'min' => 10,'message' => UserModule::t("Incorrect password (minimal length 10 symbols).")),
			array('oldPassword, password, verifyPassword', 'length', 'max'=>512, 'min' => 6,'message' => UserModule::t("Minimum 6 Characters")),
