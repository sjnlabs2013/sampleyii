...
<p class="helper"><?php echo UserModule::t("You may optionally enter a comparison operator (<b>&lt;</b>, <b>&lt;=</b>, <b>&gt;</b>, <b>&gt;=</b>, <b>&lt;&gt;</b> or <b>=</b>) at the beginning of each of your search values to specify how the comparison should be done."); ?></p>
	...
	'columns'=>array(
		...
		array(
			'class'=>'CButtonColumn',
                        ...
                        'updateButtonImageUrl' => Yii::app()->theme->baseUrl . '/images/update16x16.png',
                        'deleteButtonImageUrl' => Yii::app()->theme->baseUrl . '/images/delete16x16.png',
		),
	),
)); ?>
